...
ironman3 = media.Movie(
		...
		["Iron Man 3 delivers in spades", "Hopefully not Downey Jr's last", "Amazing Experience", "Surprising Plot Twists and Exhilarating Action"],
...
wolfofwallstreet = media.Movie(
		...
		["DeCaprio Best Performance", "Leonardo DiCaprio's Crowning Work", "Eye-Popping Revelry", "High energy and wonderfully excessive"],
...
inception = media.Movie(
		...
		"BA thief, who steals corporate secrets through use of dream-sharing technology, is given the inverse task of planting an idea into the mind of a CEO.",
		["Insanely Brilliant ! Nolan has outdone himself !!", "Nolan's first true masterpiece", "Inception May Be A Religion", "Christopher Nolan's masterpiece"],
